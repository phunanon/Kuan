...
//PROBLEM: Value can be copied many times but the copy constructor of Object isn't invoked

struct __attribute__((__packed__)) Object {
  ObjType type;
  union {
    string* str;
    immer::flex_vector<Value>* vec;
  } as;
  ...
  Object (immer::flex_vector<Value>* vec) {
    type = Vector;
    as.vec = vec;
    ++rc[ref = newRef()];
  }
  ...
  ~Object () {
    ...
    switch (type) {
      ...
      case Vector: delete as.vec; break;
    }
